...
Checkbutton_Latta.configure(command=m.latta)
...
Vale_Checkbutton.configure(command=m.Vale)
...
African_Checkbutton.configure(command=m.African)
...
American_Checkbutton.configure(command=m.American)
...
Iced_Milk_Checkbutton.configure(command=m.Iced_Milk)
...
School_Checkbutton.configure(command=m.School)
...
Sunday_Checkbutton.configure(command=m.Sunday)
...
Jonathan_Checkbutton.configure(command=m.Jonathan)
...
west_Checkbutton.configure(command=m.west)
...
Lagos_Checkbutton.configure(command=m.Lagos)
...
kilburn_Checkbutton.configure(command=m.kilburn)
...
Carlton_Checkbutton.configure(command=m.Carlton)
...
queen_Checkbutton.configure(command=m.queen)
...
Pyramid_Checkbutton.configure(command=m.Pyramid)
